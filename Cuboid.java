public class Cuboid { // Example of Multiple Constructor
    int width;
    int height;
    int depth;
    ...
    public static void main(String[] args) {
        ...
        volume = cube.volume();
        System.out.println("Volume of cube with dimensions 10 is : " + volume);

        Cuboid defaultCube = new Cuboid();
        volume = defaultCube.volume();
